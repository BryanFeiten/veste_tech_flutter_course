          ...
          return Column(
            children: [
              ...
              Container(
                ...
                child: Row(
                  children: const [
                    Icon(Icons.pin_drop_outlined, size: 16, color: Colors.black54),
                    SizedBox(width: 8),
                    Text(
                      'Informe o seu cep',
              ...
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Row(
                      children: const [
                        Text('Filtrar (2)', style: TextStyle(fontWeight: FontWeight.w500, color: Colors.blue)),
                        Icon(Icons.keyboard_arrow_down, color: Colors.blue, size: 18),
                      ],
                    ),
                  ],
                ),
                                ...
                                ElevatedButton(
                                  ...
                                  onPressed: () {
                                    ...
                                    if (added) {
                                      ...
                                      ScaffoldMessenger.of(context).showSnackBar(
                                        const SnackBar(
                                          content: Text('Produto não adicionado!'),
