...
mixin _$HomeStore on _HomeStoreBase, Store {
  ...
  int get cartQuantity => (_$cartQuantityComputed ??= Computed<int>(
    () => super.cartQuantity,
    name: '_HomeStoreBase.cartQuantity',
  )).value;
  ...
  late final _$_cartAtom = Atom(name: '_HomeStoreBase._cart', context: context);
  ...
  bool addToCart(Product p) {
    final _$actionInfo = _$_HomeStoreBaseActionController.startAction(
      name: '_HomeStoreBase.addToCart',
    );
    try {
      return super.addToCart(p);
    } finally {
